    ...
    .post(function (req, res) {  
        conn.connect().then(function () {  
            ...
            transaction.begin().then(function () {  
                ...
                request.input("plicno", sql.VarChar, req.body.licno);
                ...
                request.input("pbusactivity", sql.VarChar, req.body.busactivity);
                request.input("ptelno", sql.VarChar, req.body.telno);
                request.input("pwebsite", sql.VarChar, req.body.website == null ? "":req.body.website);
                request.input("pcurrencyid", sql.Int, req.body.currencyid);
                request.input("pannturnover", sql.Decimal, req.body.annturnover);
    ...
    .post(function (req, res) {  
        conn.connect().then(function () {  
            ...
            transaction.begin().then(function () {  
                ...
                request.input("pwebsite", sql.VarChar, req.body.website);
                request.input("pindustryid", sql.Int, req.body.industryid);
                request.input("potherindustry", sql.VarChar, req.body.otherindustry == null ? "":req.body.otherindustry);
                request.input("pproject", sql.VarChar, req.body.project);
                request.input("pcurrencyid", sql.Int, req.body.currencyid);
                request.input("pannsales", sql.Decimal, req.body.annsales);
